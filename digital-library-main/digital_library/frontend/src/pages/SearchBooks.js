...
import { FiSearch, FiMic, FiGrid, FiList, FiX, FiSliders, FiHeadphones, FiBookOpen } from 'react-icons/fi';
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div>
                      <label className="text-xs font-semibold text-brand-800 mb-2 block uppercase tracking-wide">{t('filterBy')}</label>
                        ...
                        <FiHeadphones size={14} /> {t('audioOnly')}
                      </button>
                    </div>
                    {/* Sort */}
                    <div>
        ...
        <AnimatePresence mode="wait">
          {results.length === 0 ? (
            <motion.div key="empty" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              ...
              <p className="text-5xl mb-4"><FiBookOpen size={48} className="mx-auto" /></p>
