...
import { FiUsers, FiBook, FiUpload, FiActivity, FiTrash2, FiEdit2, FiCheck, FiX, FiShield, FiHeadphones, FiGlobe, FiStar } from 'react-icons/fi';
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="grid md:grid-cols-2 gap-6">
            ...
            <div className="card p-6">
              ...
              <div className="space-y-3">
                {[
                  { icon: <FiUpload size={18} className="text-base flex-shrink-0" />, text: 'New book uploaded: "Atomic Habits"',          time: '2m ago'  },
                  { icon: <FiUsers size={18} className="text-base flex-shrink-0" />, text: 'New user registered: Samuel N.',               time: '15m ago' },
                  { icon: <FiHeadphones size={18} className="text-base flex-shrink-0" />, text: 'Audio generated for "Sapiens"',                time: '1h ago'  },
                  { icon: <FiGlobe size={18} className="text-base flex-shrink-0" />, text: 'Translation complete: EN → RW',                time: '2h ago'  },
                  { icon: <FiStar size={18} className="text-base flex-shrink-0" />, text: 'Book review: "The Alchemist" (5★)',            time: '3h ago'  },
                ].map((a, i) => (
                ...
                <tbody>
                  {books.map((b, i) => (
                    <motion.tr key={b.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.04 }}
                      ...
                      <td className="px-5 py-4 text-sm font-medium text-brand-500"><FiStar size={14} className="inline mr-1 text-yellow-400" /> {b.rating}</td>
